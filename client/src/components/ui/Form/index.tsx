...
export const Form = ({ mode = 'onSubmit', defaultValues, validationSchema, ...props }: FormProps) => {
    ...
    // Because by default, defaultValues from react-hook-form updates ONLY ONCE at the initial render,
    // even if defaultValues props changed, defaultValues wont update.
    useEffect(() => {
        if (defaultValues) {
